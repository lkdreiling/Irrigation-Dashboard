...
- [ ] 6. 🧼 Smart Cycle-Soak Recommendations
  - **Goal:** Automatically suggest splitting long runtimes into smaller cycles for clay soils to prevent runoff.
  - **Crucial Question:** What are the exact soil-and-flow thresholds that should trigger a cycle-soak warning?
...
- [ ] 23. Need to figure out infiltration rate of the soil types and suggest a cycle soak if the runtime is longer than the infil rate.
